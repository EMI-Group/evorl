...
def apply_hyperparams_to_workflow_state(hyperparams: PyTreeDict[str, chex.Numeric], workflow_state: State):
    ...
    """
    opt_states = [workflow_state.critic_opt_state, workflow_state.actor_opt_state, workflow_state.alpha_opt_state]
    ...
    workflow_state = workflow_state.replace(
        critic_opt_state=opt_states[0],
        actor_opt_state=opt_states[1],
        alpha_opt_state=opt_states[2]
    )
